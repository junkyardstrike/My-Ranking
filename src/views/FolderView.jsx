      ...
      <div className="flex items-start justify-between mb-10 premium-section-animate" style={{ animationDelay: '0ms' }}>
        <div className="flex flex-col gap-1">
          <div className="relative flex items-center gap-3 overflow-visible">
            <h1 className="text-5xl sm:text-7xl font-black tracking-tighter uppercase italic leading-none text-transparent bg-clip-text bg-gradient-to-br from-yellow-200 via-yellow-500 to-yellow-700 drop-shadow-[0_10px_20px_rgba(212,175,55,0.3)] pr-8">
              {isRoot ? 'Ranking' : currentFolder?.name}
            </h1>
            <PixelItem type="sword" size={60} />
          ...
          <p className="text-[11px] text-slate-500 font-black tracking-[0.3em] mt-3 flex items-center gap-3">
            {isRoot ? 'ランキング・アーカイブ' : `フォルダ: ${currentFolder?.name}`}
