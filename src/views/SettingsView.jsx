      ...
      <div className="flex flex-col items-center mb-10">
        <div className="flex flex-col items-center gap-1">
          <div className="relative flex items-center gap-1 overflow-visible">
            <h1 className="text-5xl sm:text-7xl font-black tracking-tighter uppercase italic leading-none text-transparent bg-clip-text bg-gradient-to-br from-purple-200 via-purple-500 to-purple-700 drop-shadow-[0_10px_20px_rgba(168,85,247,0.3)] pr-4">
              Settings
            </h1>
            <PixelItem type="key" size={40} className="mb-1" />
            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-transparent via-purple-500 to-transparent rounded-full shadow-[0_0_10px_rgba(168,85,247,0.8)]" />
          </div>
